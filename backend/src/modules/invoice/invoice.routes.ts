...
router.put("/:id", authorize("ADMIN"), validate(updateInvoiceSchema), invoiceController.updateInvoice);
router.delete("/:id", authorize("ADMIN"), invoiceController.deleteInvoice);
router.patch("/:id/status", authorize("ADMIN"), validate(updateInvoiceStatusSchema), invoiceController.updateInvoiceStatus);
