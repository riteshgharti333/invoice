...
router.post("/", authorize("ADMIN"), validate(createServiceSchema), serviceController.createService);
router.put("/:id", authorize("ADMIN"), validate(updateServiceSchema), serviceController.updateService);
