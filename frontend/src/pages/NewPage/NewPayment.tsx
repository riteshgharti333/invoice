          ...
          {selectedInvoice ? (
            <div className="p-4 bg-green-50 border border-green-200 rounded-xl space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`px-2 py-1 rounded-lg text-xs font-medium ${getStatusColor(selectedInvoice.status)}`}
                >
                  ...
                  {invoices.map((inv) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`px-2 py-0.5 rounded text-[10px] font-medium ${getStatusColor(inv.status)}`}
                        >
