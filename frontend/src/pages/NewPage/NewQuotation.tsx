...
import { TbArrowLeft, TbFileText, TbPlus, TbTrash, TbUser, TbCalendar, TbCalculator, TbCheck } from 'react-icons/tb';
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-2">Quotation Created!</h2>
    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-text-secondary text-sm mt-1">Create a new quotation for your customer</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-border p-6 space-y-4">
          <div className="flex items-center gap-3 pb-4 border-b border-border-light">
            ...
            <div>
              ...
              <p className="text-xs text-text-muted">Select customer and validity dates</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              ...
              <select
                ...
                } ${!formData.customerId ? 'text-text-muted' : ''}`}
              >
          ...
          <div className="flex items-center justify-between pb-4 border-b border-border-light">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-text-muted">Add services to quotation</p>
              </div>
            </div>
            <button
              type="button"
                ...
                <div className="md:col-span-2">
                  ...
                  <select
                    ...
                    className={`w-full px-3 py-2 bg-white border rounded-lg text-sm text-text-primary focus:outline-none focus:ring-2 focus:ring-brand/20 transition-all ${
                      !item.serviceId ? 'text-text-muted' : ''
                    }`}
                  >
