...
import { TbArrowLeft, TbFileInvoice, TbPlus, TbTrash, TbUser, TbCalendar, TbFileText, TbCash, TbCalculator, TbCheck } from 'react-icons/tb';
  ...
  const updateItem = (id: string, field: keyof LineItem, value: string | number) => {
    setFormData((prev) => ({
      ...
      items: prev.items.map((item) => {
        ...
        // Auto-fill unit price and tax when service selected
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-2">Invoice Created!</h2>
