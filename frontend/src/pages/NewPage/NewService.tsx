...
import { TbArrowLeft, TbPackage, TbFileText, TbCalculator, TbCash, TbCheck } from 'react-icons/tb';
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-2">Service Added!</h2>
    ...
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-text-secondary text-sm mt-1">Add a new service to your catalog</p>
        </div>
      </div>
