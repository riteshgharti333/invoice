...
import { TbArrowLeft, TbPackage, TbFileText, TbCalculator, TbCash, TbCheck, TbLoader } from 'react-icons/tb';
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setFormData({
        ...
        categoryId: mockService.categoryId,
        description: mockService.description,
        unit: mockService.unit,
        price: mockService.price,
        taxRate: mockService.taxRate,
      });
      setIsLoading(false);
    }, 600);
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-2">Service Updated!</h2>
          <p className="text-text-secondary">Redirecting to services page...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-text-primary">Update Service</h1>
          <p className="text-text-secondary text-sm mt-1">Edit service information</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-border p-6">
          <div className="flex items-center gap-3 pb-4 mb-5 border-b border-border-light">
            ...
            <div>
              ...
              <p className="text-xs text-text-muted">Update the service information</p>
            </div>
          </div>
