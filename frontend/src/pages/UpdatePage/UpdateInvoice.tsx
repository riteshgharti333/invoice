...
import { TbArrowLeft, TbFileInvoice, TbPlus, TbTrash, TbUser, TbCalendar, TbCalculator, TbCheck, TbLoader } from 'react-icons/tb';
...
const mockInvoice = {
  ...
  termsConditions: 'Late payment subject to 2% interest',
  status: 'SENT',
  items: [
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-2">Invoice Updated!</h2>
          <p className="text-text-secondary">Redirecting to invoices page...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold text-text-primary">Update Invoice</h1>
        ...
        <div className="bg-white rounded-2xl border border-border p-6 space-y-4">
          <div className="flex items-center gap-3 pb-4 border-b border-border-light">
            ...
            <div>
              ...
              <p className="text-xs text-text-muted">Customer and dates</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pb-4 border-b border-border-light">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-text-muted">Services included in invoice</p>
              </div>
            </div>
            <button
              type="button"
